...
<!-- ИТЕМЫ --><!-- ИТЕМЫ --><!-- ИТЕМЫ --><!-- ИТЕМЫ --><!-- ИТЕМЫ --><!-- ИТЕМЫ --><!-- ИТЕМЫ -->
    ...
    <div class="order-content-wrapper order-content-wrapper-d">
        ...
        <div class="customer">
            ...
            <? $uinfo = mqo("SELECT * FROM lc_users WHERE id='".$_SESSION["user"]."'") ?>
                    ...
                    <div class="customer-info">
                        <input placeholder="" type="text" id="basket-name" name="cart_fio" value="<?=$uinfo["fio"]?>">
                        <input placeholder="" class="wide" type="tel" id="basket-tel" name="cart_phone" value="<?=$uinfo["phone"]?>">
                        <input placeholder="" type="text" id="basket-email" name="cart_email" value="<?=$uinfo["email"]?>">
