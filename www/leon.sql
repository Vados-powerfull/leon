...
(1, 'admin@zonareklamy.ru,leone_bel@mail.ru', '', 'Сообщение с сайта leon.ru', 'Спасибо, Ваше сообщение успешно отправлено! Мы обязательно свяжемся с Вами!', 'Сообщение не было отправлено. Обратитесь к администратору!', '', 1, '');
...
CREATE TABLE `catalog` (
  ...
  `ves` double NOT NULL COMMENT 'Вес',
...
(2, 8, 'г. Курск, Гайдара 3, 2 эт, оф.6', 2);
...
CREATE TABLE `orders` (
  ...
  `adress` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Адрес',
  `summ` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Сумма заказа',
  `ves` float NOT NULL COMMENT 'Вес',
  `phone` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Телефон',
  `comment` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Комментарий',
  `details` longtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Детали заказа',
  `time_order` time NOT NULL COMMENT 'Время заказа',
...
INSERT INTO `orders` (`id`, `user_id`, `status_id`, `type_id`, `payment_status_id`, `adress`, `summ`, `ves`, `phone`, `comment`, `details`, `time_order`, `date_order`, `ordering`) VALUES
(101, 8, 1, 1, 3, '', '4400 руб', 0.5, '+7 (222) 222 22 22', '', '\n			<div class=\"order-item\">\n			<div class=\"order-img__container\">\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\n			</div>\n			<p class=\"item-name\">\n				Говядина свежая 1 сорт Говядина свежая\n			</p>\n			<div class=\"item-total\">\n				<span class=\"item-price\">4400 руб</span>\n				<span class=\"item-amount\">1 шт</span>\n			</div>\n			</div>\n	  		', '16:53:11', '2024-07-19', 0),
(102, 8, 1, 1, 3, '', '4400 руб', 0.5, '+7 (222) 222 22 22', '', '\n			<div class=\"order-item\">\n			<div class=\"order-img__container\">\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\n			</div>\n			<p class=\"item-name\">\n				Говядина свежая 1 сорт Говядина свежая\n			</p>\n			<div class=\"item-total\">\n				<span class=\"item-price\">4400 руб</span>\n				<span class=\"item-amount\">1 шт</span>\n			</div>\n			</div>\n	  		', '14:21:11', '2024-07-23', 0),
(118, 13, 1, 0, 3, '', '10015', 501.513, '', '', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">2 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Свинина свежая 3 сорт Свинина черкизово</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">5615 руб</span>\r\n				<span class=\"item-amount\">4 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">2 шт</span>\r\n			</div>\r\n		</div>', '16:57:08', '2024-09-19', 0),
(119, 13, 1, 0, 3, '', '31260', 501.513, '', '', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">2 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Свинина свежая 3 сорт Свинина черкизово</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">5615 руб</span>\r\n				<span class=\"item-amount\">4 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">2 шт</span>\r\n			</div>\r\n		</div>', '16:59:15', '2024-09-19', 0),
(120, 13, 1, 0, 3, '', '31260', 501.513, '', '', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">2 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Свинина свежая 3 сорт Свинина черкизово</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">5615 руб</span>\r\n				<span class=\"item-amount\">4 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">2 шт</span>\r\n			</div>\r\n		</div>', '16:59:20', '2024-09-19', 0),
(121, 13, 1, 0, 3, '', '36875', 501.513, '', '', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">2 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Свинина свежая 3 сорт Свинина черкизово</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">5615 руб</span>\r\n				<span class=\"item-amount\">5 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">2 шт</span>\r\n			</div>\r\n		</div>', '17:02:42', '2024-09-19', 0),
(122, 13, 1, 0, 3, '', '36875', 501.513, '', '', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">2 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Свинина свежая 3 сорт Свинина черкизово</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">5615 руб</span>\r\n				<span class=\"item-amount\">5 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">2 шт</span>\r\n			</div>\r\n		</div>', '17:04:49', '2024-09-19', 0),
(124, 0, 1, 2, 0, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (950) 877 77 73', 'корзина', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:06:34', '2024-09-20', 0),
(125, 15, 1, 2, 20000000, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (950) 877 77 73', 'корзина', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:22:05', '2024-09-20', 0),
(126, 13, 1, 0, 0, '', '4400', 500, '', '', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:27:20', '2024-09-20', 0),
(127, 14, 1, 1, 0, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (950) 877 77 73', 'корзина', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:27:31', '2024-09-20', 0),
(128, 14, 1, 0, 0, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (950) 877 77 73', 'корзина', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:32:57', '2024-09-20', 0),
(129, 13, 1, 0, 0, '', '4400', 500, '', '', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:39:18', '2024-09-20', 0),
(130, 16, 1, 0, 0, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (910) 321 23 23', 'корзина2', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:39:24', '2024-09-20', 0),
(131, 14, 1, 0, 0, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (950) 877 77 73', 'корзина', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:44:37', '2024-09-20', 0),
(132, 14, 1, 0, 0, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (950) 877 77 73', 'корзина', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:53:00', '2024-09-20', 0),
(133, 14, 1, 0, 0, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (950) 877 77 73', 'корзина', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:55:07', '2024-09-20', 0),
(134, 14, 1, 0, 0, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (950) 877 77 73', 'корзина', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '16:59:24', '2024-09-20', 0),
(135, 14, 1, 0, 1, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (950) 877 77 73', 'корзина', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '17:03:34', '2024-09-20', 0),
(136, 14, 1, 0, 1, 'Пр-т Хрущева, дом 29, кв. 50', '4400', 500, '+7 (950) 877 77 73', 'корзина', '<div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"/public/img/items/3.png\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\">Говядина свежая 1 сорт Говядина свежая</p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\">4400 руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div><div class=\"order-item\">\r\n			<div class=\"order-img__container\">\r\n				<img class=\"item-img\" src=\"\" alt=\"\" />\r\n			</div>\r\n			<p class=\"item-name\"></p>\r\n			<div class=\"item-total\">\r\n				<span class=\"item-price\"> руб</span>\r\n				<span class=\"item-amount\">1 шт</span>\r\n			</div>\r\n		</div>', '17:12:24', '2024-09-20', 0),
...
INSERT INTO `orders_status` (`id`, `name`, `ordering`) VALUES
(1, 'Новый', 1),
(2, 'Завершен', 3),
(3, 'Собирается', 2);
...
--
-- Дамп данных таблицы `orders_type`
--

INSERT INTO `orders_type` (`id`, `name`, `ordering`) VALUES
(1, 'Самовывоз', 1),
(2, 'Доставка', 2);
...
CREATE TABLE `pages` (
  `id` int(11) NOT NULL,
  `meta_desc` text NOT NULL COMMENT 'Мета-тег описание',
  `meta_key` varchar(250) NOT NULL COMMENT 'Мета-тег ключевые слова',
  `meta_title` varchar(250) NOT NULL COMMENT 'Мета-тег заголовок',
  `page_title` varchar(250) NOT NULL COMMENT 'Заголовок страницы(sys_name)',
  `page_text` longtext NOT NULL COMMENT 'Текст страницы',
...
(6, 0, '2e7f871b-000f-5000-9000-1c0c9edf3ec5', 'succeeded', '4400.00', 'RUB', 'bank_card', '2024-09-20 16:06:35', '2024-09-20 13:07:02'),
(7, 125, '2e7f8abd-000f-5000-9000-1ac5948c5527', 'succeeded', '4400.00', 'RUB', 'bank_card', '2024-09-20 16:22:06', '2024-09-20 13:22:23'),
(8, 127, '2e7f8c04-000f-5000-8000-1a160cb97efc', 'succeeded', '4400.00', 'RUB', 'bank_card', '2024-09-20 16:27:32', '2024-09-20 13:27:48'),
(9, 128, '2e7f8d49-000f-5000-8000-1bca8d321da6', 'succeeded', '4400.00', 'RUB', 'bank_card', '2024-09-20 16:32:57', '2024-09-20 13:33:15'),
(10, 130, '2e7f8ecd-000f-5000-8000-11a80b2304ba', 'succeeded', '4400.00', 'RUB', 'bank_card', '2024-09-20 16:39:26', '2024-09-20 13:39:38'),
(11, 131, '2e7f9005-000f-5000-8000-14f629f88b81', 'succeeded', '4400.00', 'RUB', 'bank_card', '2024-09-20 16:44:37', '2024-09-20 13:44:59'),
(12, 132, '2e7f91fc-000f-5000-8000-173a4c361688', 'pending', '4400.00', 'RUB', NULL, '2024-09-20 16:53:00', '2024-09-20 13:53:00'),
(13, 133, '2e7f927b-000f-5000-9000-103e3a670eaf', 'pending', '4400.00', 'RUB', NULL, '2024-09-20 16:55:07', '2024-09-20 13:55:07'),
(14, 134, '2e7f937d-000f-5000-8000-1f8fc212b563', 'pending', '4400.00', 'RUB', NULL, '2024-09-20 16:59:25', '2024-09-20 13:59:25'),
(15, 135, '2e7f9476-000f-5000-9000-1c3fba9f3d14', 'succeeded', '4400.00', 'RUB', 'bank_card', '2024-09-20 17:03:34', '2024-09-20 14:03:56'),
(16, 136, '2e7f9688-000f-5000-9000-15e30f2ee41b', 'succeeded', '4400.00', 'RUB', 'bank_card', '2024-09-20 17:12:24', '2024-09-20 14:12:43'),
(17, 137, '2e7f9737-000f-5000-9000-16d43c826c83', 'succeeded', '4400.00', 'RUB', 'bank_card', '2024-09-20 17:15:19', '2024-09-20 14:15:33'),
(18, 138, '2e7f9866-000f-5000-8000-1eece36890b9', 'succeeded', '4400.00', 'RUB', 'bank_card', '2024-09-20 17:20:22', '2024-09-20 14:20:39'),
(19, 139, '2e7f9937-000f-5000-9000-17b60ada4268', 'succeeded', '8800.00', 'RUB', 'bank_card', '2024-09-20 17:23:52', '2024-09-20 14:24:07'),
(20, 140, '2e7f9f45-000f-5000-8000-18705937bfc2', 'succeeded', '8800.00', 'RUB', 'bank_card', '2024-09-20 17:49:41', '2024-09-20 14:50:01');
...
(4, 'Ожидает исполнения', 'waiting_for_capture');
...
(69, 'orders_status', 'orders', 'id', 'status_id', 'name', '', 0, 0, 1, 22),
(70, 'orders_type', 'orders', 'id', 'type_id', 'name', '', 0, 0, 1, 23),
(71, 'payments_status', 'payments', 'id', 'order_id', 'name', '', 0, 0, 1, 24),
(72, 'payments_status', 'orders', 'id', 'payment_status_id', 'name', '', 0, 0, 1, 25),
(73, 'lc_users', 'orders', 'id', 'user_id', 'fio', '', 0, 0, 1, 26);
