...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 20 2024 г., 13:40
...
CREATE TABLE `orders` (
  ...
  `payment_id` int(11) NOT NULL COMMENT 'Статус оплаты заказа',
  `adress` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Адрес',
...
INSERT INTO `orders` (`id`, `user_id`, `status_id`, `type_id`, `payment_id`, `adress`, `summ`, `ves`, `phone`, `comment`, `details`, `time_order`, `date_order`, `ordering`) VALUES
...
(72, 'payments_status', 'orders', 'id', 'payment_id', 'name', '', 0, 0, 1, 25),
